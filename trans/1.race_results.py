...
drivers_df = spark.read.parquet("dbfs:/user/hive/warehouse/f1_processed.db/drivers") \
...
constructors_df = spark.read.parquet("dbfs:/user/hive/warehouse/f1_processed.db/constructors") \
.withColumnRenamed("name", "team") 

# COMMAND ----------

circuits_df = spark.read.parquet("dbfs:/user/hive/warehouse/f1_processed.db/circuits") \
.withColumnRenamed("location", "circuit_location") 

# COMMAND ----------

races_df = spark.read.parquet("dbfs:/user/hive/warehouse/f1_processed.db/races") \
.withColumnRenamed("name", "race_name") \
.withColumnRenamed("race_timestamp", "race_date") 

# COMMAND ----------

results_df = spark.read.parquet("dbfs:/user/hive/warehouse/f1_processed.db/results").filter(f"file_date = '{v_file_date}'") \
